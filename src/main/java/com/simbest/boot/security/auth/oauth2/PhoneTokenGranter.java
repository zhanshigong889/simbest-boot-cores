...
/**
 * 用途：基于RSA加密手机号码的认证OAUTH2方式提交的认证主体
 ...
 */
@Slf4j
public class PhoneTokenGranter extends Oauth2ExtendTokenGranter {
    ...
    protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
        ...
        log.debug("OAUTH2即将通过PhoneTokenGranter进行认证，appcode【{}】phone【{}】", appcode, phone);
        Authentication userAuth = new PhoneAuthenticationToken(phone, appcode);
