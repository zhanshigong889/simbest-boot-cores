...
public class QrCodeUtil {
    ...
    public static void main(String[] args) throws Exception {
        String text = "https://m.ha.chinamobile.com:8001/download.html";
        //不含Logo
        //QrCodeUtil.encode(text, null, "e:\\", true);
        //含Logo，不指定二维码图片名
        //QrCodeUtil.encode(text, "e:\\csdn.jpg", "e:\\", true);
        //含Logo，指定二维码图片名
        QrCodeUtil.encode(text, "C:\\Users\\lenovo\\Desktop\\pic01.png", "C:\\Users\\lenovo\\Desktop\\", "maip", true);
        String result = QrCodeUtil.decode("C:\\Users\\lenovo\\Desktop\\maip.jpg");
